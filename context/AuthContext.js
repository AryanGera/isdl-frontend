...
export const AuthProvider = ({children}) =>{
    ...
    let loginUser = async (e) => {
        ...
        e.preventDefault()
        let response = await fetch("https://recruitsys.onrender.com/login", {
            method: 'POST',
            headers:{
    ...
    let preReq = async() => {
      const resp2 = await fetch(
        "https://recruitsys.onrender.com/fetchAllJobs",
        {
          method: "GET",
        }
      );
      ...
      const resp3 = await fetch(
        "https://recruitsys.onrender.com/fetchAllSpez",
        {
          method: "GET",
        }
      );
    ...
    let sendForm = async (e) => {
      ...
      const formData = new FormData(e.target);
        ...
        console.log(data);
        let response = await fetch("https://recruitsys.onrender.com/registerApp", {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
    ...
    let createJob = async (e) => {
        ...
        const formData = new FormData(e.target);
          ...
          console.log(data);
          let response = await fetch("https://recruitsys.onrender.com/createJob?"+new URLSearchParams({ jwt: authToken }), {
            method: "POST",
            headers: {
              "Content-Type": "application/json",
            },
