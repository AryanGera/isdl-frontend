    ...
    return (
      <div>
        ...
        <form onSubmit={sendForm} id="form"  className={regStyles.form}>
          {1===0 && <input type="number" placeholder="fuck" name='jobid'/>}
          <Text fontSize={25}>Personal Details</Text>
          <Flex>Specialization</Flex>
          <Select placeholder="Please Select" name="spez" onChange={(e) => nhp(e)} required>
            {v
              .map(p => (
          ...
          <Flex> Qualifications
          <Select placeholder="Please Select" name="qualifications" required>
            {
